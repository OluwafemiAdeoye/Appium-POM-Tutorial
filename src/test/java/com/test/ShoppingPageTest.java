...
//	}
    ...
    @Test
    public void letsShop() throws IOException, InterruptedException {

        AndroidDriver driver = capabilities("General-Store");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

//        GeneralStorePageTest generalStorePageTest = new GeneralStorePageTest();
//        generalStorePageTest.shoppingDay();
//        Thread.sleep(3000);
